...
def test_build_chamber_route_features():
    ...
    approach_segments = [f for f in features if f["properties"].get("segment_type") == "chamber_approach"]
    ...
    route_segments = [f for f in features if f["properties"].get("segment_type") == "chamber_route"]
    ...
    # Check Exit Segment
    exit_segments = [f for f in features if f["properties"].get("segment_type") == "chamber_exit"]
