...
class GraphValidator:
    ...
    def check_border_integrity(self) -> Dict[str, Any]:
        ...
        integrity = {
            ...
            "connections": [
                {"u": u, "v": v, "gap": d.get("distance_gap")}
                for u, v, d in border_edges
            ],
        }
            ...
            checks.append(
                {
                    "name": "Lobith Connection",
                    "status": "WARNING",
                    "details": "FIS_22638200 not found in border connections",
                }
            )
    ...
    def generate_markdown_report(self) -> str:
        ...
        sources = set(
            list(stats["nodes_by_source"].keys())
            + list(stats["edges_by_source"].keys())
        )
